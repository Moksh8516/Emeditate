...
import { FiFile, FiFolder, FiClock, FiDownload, FiMoreVertical } from 'react-icons/fi';
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-4">
        <div className="max-w-4xl mx-auto py-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h3 className="mt-4 text-2xl font-bold text-gray-900">Error Loading Documents</h3>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {documents.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
            ...
            <h3 className="mt-6 text-2xl font-bold text-gray-900">No documents found</h3>
            <p className="mt-2 text-gray-600 max-w-md mx-auto">
              Get started by uploading your first file to the AI training library.
            </p>
            <div className="mt-8">
